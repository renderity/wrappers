...
namespace RDTY::WRAPPERS
{
	...
	struct Material : public Base
	{
		...
		std::string code_glsl100es_vertex
		{R"(
			precision highp int;
		...
		std::string code_glsl100es_fragment
		{R"(
			precision highp int;
			precision highp float;
		...
		std::string code_glsl300es_vertex
		{R"(
			#version 300 es
		...
		std::string code_glsl300es_fragment
		{R"(
			#version 300 es
